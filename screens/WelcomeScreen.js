    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          {/* <BarterAnimation/> */}
          <Text style={styles.title}>Study Point</Text>
          <Text style={{color:'#32867d'}}> A new way of learning </Text>
        </View>
        <View style={styles.buttonContainer}>
          <Text style={{color:'#32867d', fontSize:18, fontWeight:'bold',marginLeft:55}}>emailId</Text>
